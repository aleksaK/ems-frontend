...
const DepartmentComponent = () => {
    ...
    function createOrUpdateDepartment(e) {
        e.preventDefault();
        if (validateForm()) {
    ...
    return (
        <div className='container'>
            <br />
            <div className='row'>
                <div className='card call-md-6 offset-md-3 offset-md-3'>
                    {pageTitle()}
                    <div className='card-body'>
                        <form>
                            ...
                            <button className='btn btn-success mb-2' onClick={createOrUpdateDepartment}>Submit</button>
                        </form>
                    </div>
                </div>
            </div>
